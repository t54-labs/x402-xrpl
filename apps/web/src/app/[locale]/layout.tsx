...
import { LOCALES, isLocale } from "@/app/lib/i18n";
...
import { CookieConsent, CookieSettingsLink } from "@/app/components/CookieConsent";
        ...
        <footer className="border-t border-[rgba(255,255,255,0.06)] py-8">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            ...
            <div className="flex flex-wrap items-center justify-start sm:justify-center gap-x-4 gap-y-1 text-[11px] text-[var(--text-muted)]">
              <Link href="/terms" className="inline-flex items-center min-h-[40px] hover:text-[var(--text-secondary)] transition-colors">{t.footer.terms}</Link>
              <Link href="/privacy" className="inline-flex items-center min-h-[40px] hover:text-[var(--text-secondary)] transition-colors">{t.footer.privacy}</Link>
